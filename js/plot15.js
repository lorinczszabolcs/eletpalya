...
(function() {
  ...
  loadJSON(function(response) {
    ...
    var layout =
    {
      title: "<b class='text-center'>Szakterületek csoportosítása tanulmányok szerint</b>",
      "font":
      {
  ...
  }, '../eletpalya/data/stud_work_heatmap.json');
  //}, '../data/stud_work_heatmap.json');
