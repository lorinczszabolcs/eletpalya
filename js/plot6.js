...
(function() {
  ...
  loadJSON(function(response) {
    ...
    var layout =
    {
      title: "<b class='text-center'>Tanulmányok csoportosítása lakhely szerint<br>(normalizálva)</b>",
      "titlefont":
      {
        "size": 20,
  ...
  }, '../eletpalya/data/live_stud_normalized.json');
  //}, '../data/live_stud_normalized.json');
