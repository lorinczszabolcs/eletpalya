...
(function() {
  ...
  loadJSON(function(response) {
    ...
    var layout =
    {
      title: "<b class='text-center'>Tanulmányok csoportosítása születési hely szerint</b>",
      "font":
      {
  ...
  }, '../eletpalya/data/birth_stud_heatmap.json');
  //}, '../data/birth_stud_heatmap.json');
