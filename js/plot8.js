...
(function() {
  ...
  loadJSON(function(response) {
    ...
    var layout =
    {
      title: "<b class='text-center'>Szakterületek csoportosítása lakhely szerint<br>(normalizálva)</b>",
      "titlefont":
      {
        "size": 20,
      },
  ...
  }, '../eletpalya/data/live_work_normalized.json');
