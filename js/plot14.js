...
(function() {
  ...
  loadJSON(function(response) {
    ...
    var layout =
    {
      title: "<b class='text-center'>Szakterületek csoportosítása lakhely szerint</b>",
      "font":
      {
  ...
  }, '../eletpalya/data/live_work_heatmap.json');
  //}, '../data/live_work_heatmap.json');
