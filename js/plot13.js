...
(function() {
  ...
  loadJSON(function(response) {
    ...
    var layout =
    {
      title: "<b class='text-center'>Szakterületek csoportosítása születési hely szerint</b>",
      "font":
      {
  ...
  }, '../eletpalya/data/birth_work_heatmap.json');
  //}, '../data/birth_work_heatmap.json');
